...
public class SimpleWalletProcessor {
	...
	// step 1. connect to validator with connection string (tcp://validator:4004)
	TransactionProcessor simpleWalletProcessor = new TransactionProcessor(args[0]);
	// Create simple wallet transaction handler and register with validator
 ...
 * with validator
 * It sets the namespaceprefix, versions and types of operations
